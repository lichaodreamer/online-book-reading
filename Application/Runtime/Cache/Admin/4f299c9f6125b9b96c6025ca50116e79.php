...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">书架管理</span></div>
        </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($shelf)): $i = 0; $__LIST__ = $shelf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-del" href="javascript:void(0);" name='<?php echo ($s["bid"]); ?>,<?php echo ($s["username"]); ?>'>删除</a>
                            </td>
...
<script type="text/javascript">
    $(".link-del").click(function(){
        $delshelf="<?php echo U('Admin/Shelf/delshelf');?>";
        ...
        $.post($delshelf,$data,function(msg){
            if(msg==1){
                $that.remove();
            }else{
                alert("删除失败了");
