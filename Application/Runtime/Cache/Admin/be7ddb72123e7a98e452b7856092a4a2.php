                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($mark)): $i = 0; $__LIST__ = $mark;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-del" href="javascript:void(0);" name='<?php echo ($m["bid"]); ?>,<?php echo ($m["cid"]); ?>,<?php echo ($m["username"]); ?>'>删除</a>
                            </td>
...
<script type="text/javascript">
    $(".link-del").click(function(){
        $delmark="<?php echo U('Admin/Mark/delmark');?>";
        ...
        $.post($delmark,$data,function(msg){
            if(msg==1){
                $that.remove();
            }else{
                alert("删除失败了");
