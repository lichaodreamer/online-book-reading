		...
		<div class="container">
			<div class="row">
				...
				<div class="row">
					<div class="col-md-9"> 
		        <div class="col-md-4">
		        	<a href="<?php echo U('Home/Index/reading');?>/id/<?php echo ($b["bid"]); ?>"><img src="/bookreading/Public/home/images/bookPhoto/<?php echo ($b["bphoto"]); ?>"></a>
		        </div>  
		        <div class="col-md-8">
						...
						<ul class="list-group">
							<?php if(is_array($books)): foreach($books as $key=>$bs): if($bs["bid"] == 1): ?><li class="list-group-item">
											...
											<div class="row" style="display: block;">
												<div class="col-md-4">
													<img src="/bookreading/Public/home/images/bookPhoto/<?php echo ($bs["bphoto"]); ?>">
												</div>
												<div class="col-md-7">
